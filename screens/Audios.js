...
const dymaniclink =
  "https://tlexinstitute.page.link/?link=https://www.tlexinstitute.com/app?meditation%3D";

const deeplink =
  "&apn=com.tlexinsitute.tlexmindfullness&ibi=com.tlexinstitute.tlexmindfullness";

export default class Audios extends React.PureComponent<ScreenProps<>> {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <BaseContainer title="" navigation={this.props.navigation} backBtn>
        ...
        <View style={style.container}>
          ...
          {connected && (
            <TouchableOpacity
              style={style.btnFavWrapper}
              onPress={this.handleHeartClick}
            >
              <View
                style={{
                  height: 35,
          ...
          {music == "yes" && (
            <View style={style.section}>
              ...
              >
                ...
                {translate("Audios.background")}
              </Text>
            </View>
          )}
          <View style={style.section}>
            <Icon name={"ios-code-working"} style={{ color: COLORS.orange }} />
            <Text
              style={{
                paddingLeft: 32,
                flexWrap: "wrap",
...
const DownloadButton = (props) => (
  <TouchableOpacity
    style={style.btnDownloadWrapper}
    onPress={props.handleClick}
    enabled={!props.downloading}
    activeOpacity={props.downloading ? 1 : 0.5}
  >
    <View
      style={{
        height: 35,
    ...
    >
      {!props.downloading ? (
        <Ionicons
          ...
          color={props.downloadEnabled ? COLORS.gray : COLORS.orange}
          size={28}
        />
      ) : (
...
const style = StyleSheet.create({
  ...
  audioTitle: {
    ...
    /*    borderColor: 1
    textShadowOffset
    ReactPropTypes.shape( {width: ReactPropTypes.number, height: ReactPropTypes.number} )
